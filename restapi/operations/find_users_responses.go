...
/*
FindUsersDefault unexpected error
...
func (o *FindUsersDefault) WithPayload(payload *models.ErrorModel) *FindUsersDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the find users default response
func (o *FindUsersDefault) SetPayload(payload *models.ErrorModel) {
	o.Payload = payload
}
