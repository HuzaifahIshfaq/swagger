...
func NewSampleAPIAPI(spec *loads.Document) *SampleAPIAPI {
	return &SampleAPIAPI{
		...
		AddUserHandler:    NewAddUserHandler(),
		FindUsersHandler: NewFindUsersHandler(),
...
type SampleAPIAPI struct {
	...
	// FindUsersHandler sets the operation handler for the find users operation
...
func (o *SampleAPIAPI) Validate() error {
	...
	if o.FindUsersHandler == nil {
		unregistered = append(unregistered, "FindUsersHandler")
	}
...
func (o *SampleAPIAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/users"] = NewFindUsers(o.context, o.FindUsersHandler)
	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	o.handlers["PUT"]["/users/{id}"] = NewUpdateUser(o.context, o.UpdateUserHandler)
}
